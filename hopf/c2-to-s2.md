...
&&&rem 双線形という呼び方について
$z_0^*z_1$のように、$z_0,z_1$のペアから片方だけを共役にして掛け合わせた式は、$z_1$については線形（1次）ですが、$z_0$については複素共役を取っているため、厳密には線形ではありません。複素共役は$\mathbb C$上では線形写像ではなく、$\mathbb R$上でのみ線形な**共役線形** (conjugate-linear) 写像だからです。
