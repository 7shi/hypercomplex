...
&&&rem
$AP$の$\beta$の係数$(\sigma_1-i\sigma_2)/2$は、スピンの下降演算子$\sigma_-$と呼ばれます。これは射影$P$が$\sigma_3$方向のヌルベクトルから作られていることに由来し、このような構成は一般に**純粋スピノル**と呼ばれ、複素化したクリフォード代数における極大等方部分空間と対応づけられます。
&&&
