...
2. [八元数の左作用とクリフォード代数](02-oct-left-mul.md) — 八元数の左作用の行列表現。左作用が生成するクリフォード代数$C\ell_{0,6}(\mathbb R)\cong M_8(\mathbb R)$の構造、右作用の左作用による表現、スピノルへの射影$P$とその復元、非結合性が見せる構造について。
